...
declare namespace p {
     ...
     * global {@link p} object. For JavaScript you can use {@link
     ...
     * 
     * The global {@link p} object is simply a reference to the currently active
     * `PaperScope`.
     */
    class PaperScope  {
        /** 
    ...
    namespace Path {
        ...
        class Rectangle extends Path {
             ...
             */
            constructor(rectangle: p.Rectangle, radius?: Size)
        ...
        class Ellipse extends Path {
             ...
             */
            constructor(rectangle: p.Rectangle)
...
{
    const paperCore: Pick<p.PaperScope, Exclude<keyof p.PaperScope, 'PaperScript'>>;
    export = paperCore
}

declare module 'paper'
{
    const paperFull: p.PaperScope;
    export = paperFull
}
